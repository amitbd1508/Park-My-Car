...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carmodel= (EditText) findViewById(R.id.input_carmodel);
        carnumber= (EditText) findViewById(R.id.input_carnumber);
    ...
    public void signup() {
        ...
        if(password==reEnterPassword)
        {
            ...
            user.carModel=carmodel.getText().toString();
            user.carNumber=carnumber.getText().toString();
            user.phone=phone.getText().toString();
            user.type=App.CN_USER;
            user.latitude="-1";
            user.longitude="-1";
